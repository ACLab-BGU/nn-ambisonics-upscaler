...
arguments
    ...
    opts.bpfFlag (1,1) logical % if array_type is "anm", default is false. otherwise, default is true.
...
% default value for opts.bpfFlag
if ~isfield(opts, "bpfFlag")
    opts.bpfFlag = opts.array_type ~= "anm";
end
...
switch opts.array_type
    ...
    otherwise
        ...
        h = anm2p(hnm, fs, opts.array_radius, opts.array_omega, opts.array_type, opts.isComplexSH);
end

%% BPF to make IR more realistic
if ~isempty(opts.bpfLimits)
