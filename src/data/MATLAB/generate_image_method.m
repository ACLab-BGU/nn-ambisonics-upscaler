...
for i=1:numel(num_of_reflections)
    ...
    mkdir(folder_path);
    make_image_method_data(num_of_files, 1, "number_of_reflections", num_of_reflections(i), "folder_path", folder_path, "source_type", source_type(i),...
        "duration",sig_length, "target_sh_order",target_sh_order,"compact_cov",compact_cov);
end
